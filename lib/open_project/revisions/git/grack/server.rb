  ...
  class Server
    ...
    private
      ...
      def gitolite_path(path)
        File.join(OpenProject::Revisions::Git::Config.gitolite_home_dir, OpenProject::Revisions::Git::Config.gitolite_global_storage_dir, OpenProject::Revisions::Git::Config.gitolite_redmine_storage_dir, path)
      end
