  ...
  class Git
    ...
    private
      ...
      def git_command_with_chdir
        OpenProject::Revisions::Git::Commands.sudo_git_args_for_repo(@repo, smart_http_args)
      end
      ...
      def smart_http_args
        [
          'env',
          "GL_BINDIR=#{OpenProject::Revisions::Git::Config.gitolite_bin_dir}",
          "GL_LIBDIR=#{OpenProject::Revisions::Git::Config.gitolite_lib_dir}",
      ...
      def repository_object
        @repository_object ||= Repository::Gitolite.find_by_path(@repo)
      end
