    ...
    private
      ...
      def hook_file_has_changed?
        OpenProject::Revisions::Git::Commands.sudo_file_changed?(source_path, destination_path) ||
          OpenProject::Revisions::Git::Commands.sudo_file_perms_changed?(filemode, destination_path)
      end
      ...
      def install_hook_file
        ...
        begin
          ...
          OpenProject::Revisions::Git::Commands.sudo_install_file(content, destination_path, filemode)
        end
      end
